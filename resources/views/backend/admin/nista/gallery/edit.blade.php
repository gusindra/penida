            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1 flex justify-between">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium text-gray-900">Image edit</h3>
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <form method="POST" enctype="multipart/form-data" action="{{route('update.gallery', $hal->id)}}"
                        id="form">
                        @csrf
                                    ...
                                    <ul class="thumbnails">
                                        <li class="span2"> <a> <img src="{{url($hal->url)}}" alt=""> </a>
                                            <div class="actions"> <a class="lightbox_trigger"
                                                    href="{{url($hal->url)}}"><i class="icon-search"></i></a> </div>
                                        </li>
                                    </ul>
